...
const todasPerguntas = [
    {
      pergunta: "Maria Eduarda foi estuprada quando saía de casa para trabalhar por volta das 5h da manhã de uma segunda-feira. Você faz ideia da média de estupros registrados no Brasil no ano de 2021?",
      ...
      informacaoAcerto: "Você acertou. Infelizmente, a média em 2021 foi de 1 estupro a cada 10 minutos. Houve aumento de 3,7% em relação a 2020, segundo o Fórum Brasileiro de Segurança Pública. Foram 56 mil casos, incluindo estupros de meninas menores de 14 anos e de mulheres incapazes de consentir ou de oferecer resistência.",
      informacaoErro: "Você errou. Infelizmente, a média em 2021 foi de 1 estupro a cada 10 minutos. Houve aumento de 3,7% em relação a 2020, segundo o Fórum Brasileiro de Segurança Pública. Foram 56 mil casos, incluindo estupros de meninas menores de 14 anos e de ou mulheres incapazes de consentir ou de oferecer resistência.",
    },
    {
    ...
    {
      pergunta: "Maria Clara, 12 anos, faltou à aula hoje. Ela está menstruada e sua mãe mais vez teve que usar o pouco dinheiro que tinha com itens básicos de alimentação, ainda assim, hoje ela não terão o que jantar. Você imagina qual é o índice de adolescentes que não possui absorventes durante seu período menstrual?",
